			...
			<div class="col-md-12">
				...
				<form name="form" role="form" ng-controller="MainCtrl">
					...
					<div class="form-group">
						...
						<div class="input-group col-md-3 has-success">
							<select name="select_universidad" id="id_select_universidad" class="form-control"  >
								<option value="UCR">Universidad de Costa Rica</option>
								<option value="UNA">Universidad Nacional</option>
								<option value="UL">Universidad Latina</option>
							</select>
							<span class="input-group-addon"><a href="#" data-toggle="tooltip" data-placement="top" title="Elija la Universidad a buscar"><img src="images/question_icon.png" style="width:20px;height:20px;"></a></span>
						</div>
					</div>
							...
							<div id="tablas_areas" style='display:none;'>
								...
								<div id="table_GR" style='display:none;'>
									...
									<table class="table table-hover" id="tabla_gestion_recursos" >
										<tr>
											<th>Año</th>
											<th>Política de Gestión Ambiental</th>
											...
											<th>Comisión de Gestión Ambiental</th>
										</tr>
										<tr>
											<td>2014</td>
											<td>Si</td>
								...
								<div id="tabla_Gestion" style='display:none;'>
									...
									<table class="table table-hover">
										<tr>
											...
											<th>GR Política de Gestión Ambiental</th>
											...
											<th>GR Comision de Gestión Ambiental</th>
